...
function preload(){
	boy=loadImage("images/choose plucking_mangoes_img-removebg-preview.png");
  }
...
function setup() {
  ...
  Roca = new Launcher(stoneObj.body,{x: 210,y: 340});
